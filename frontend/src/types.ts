...
export interface DemoCase { id: string; ticket_id: string; company_id: string; requester_id: string; asset_id: string; initial_message: string; source_case_id: string | null; immutable: boolean; simulation_mode: "standard" | "complete" | "degraded" | "custom_seed"; seed: string | null; created_at: string }

...
export const api = {
  ...
  create: (data: { source_case_id?: string; company_id: string; requester_id: string; asset_id: string; message: string; simulation_mode: string; seed?: string }) => request<DemoCase>("/v1/cases", { method: "POST", body: JSON.stringify(data) }),

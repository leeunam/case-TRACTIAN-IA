...
- Para conhecimento global, `search_knowledge` aceita somente consulta sem espaços externos, de 2 a 200 caracteres, e o filtro fechado `procedure`/`glossary`/`guidance`. A busca normaliza todos os documentos antes do corte de 10 metadados/snippets de 240 caracteres; o detalhe limita o corpo a 8.000 caracteres no contexto do modelo e 32.000 no artifact, sempre declarando caracteres retornados, omitidos e truncamento.
